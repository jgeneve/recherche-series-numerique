...
import com.imt.seriesNumerique.GeneratedConstraints;
...
//	}
	...
	public void test_min_max_peak() throws Exception {
		...
		Integer expected = 3;
		assertEquals(expected, GeneratedConstraints.min_max_peak(input));
	}
	...
	public void test_min_max_increasing() throws Exception {
		...
		Integer expected = 3;
		assertEquals(expected, GeneratedConstraints.min_max_increasing(input));
	}
	...
	public void test_min_max_increasing_sequence() throws Exception {
		...
		List<Integer> input = Arrays.asList(4,3,5,5,2,1,1,3,3,4,6,6,3,1,3,3);
		Integer expected = 3;
		assertEquals(expected, GeneratedConstraints.min_max_increasing_sequence(input));
	}
	...
	public void test_max_min_zigzag() throws Exception {
		...
		Integer expected = 1;
		assertEquals(expected, GeneratedConstraints.max_min_zigzag(input));
	}
	...
	public void test_max_range_decreasing() throws Exception {
		...
		Integer expected = 2;
		assertEquals(expected, GeneratedConstraints.max_range_decreasing(input));
	}
	...
	public void test_max_range_decreasing_sequence() throws Exception {
		...
		List<Integer> input = Arrays.asList(3,4,2,2,5,6,6,4,4,3,1,1,4,6,4,4);
		Integer expected = 5;
		assertEquals(expected, GeneratedConstraints.max_range_decreasing_sequence(input));
	}
