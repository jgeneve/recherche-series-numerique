...
public class TimeSeriesConstraints {
    ...
    public static Integer min_one_bump_on_decreasing_sequence(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(BUMP_ON_DECREASING_SEQUENCE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_decreasing(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(DECREASING, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_decreasing_sequence(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(DECREASING_SEQUENCE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_decreasing_terrace(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(DECREASING_TERRACE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_dip_on_increasing_sequence(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(DIP_ON_INCREASING_SEQUENCE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_gorge(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(GORGE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_increasing(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(INCREASING, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_increasing_sequence(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(INCREASING_SEQUENCE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_increasing_terrace(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(INCREASING_TERRACE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_inflexion(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(INFLEXION, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_plain(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PLAIN, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_plateau(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PLATEAU, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_proper_plain(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PROPER_PLAIN, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_proper_plateau(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PROPER_PLATEAU, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_steady(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(STEADY, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_steady_sequence(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(STEADY_SEQUENCE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_strictly_decreasing_sequence(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(STRICTLY_DECREASING_SEQUENCE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_strictly_increasing_sequence(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(STRICTLY_INCREASING_SEQUENCE, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_summit(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(SUMMIT, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_valley(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(VALLEY, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_one_zigzag(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(ZIGZAG, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_surf_peak(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PEAK, serie);
        List<Integer> resultsFeature = surf(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_max_peak(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PEAK, serie);
        List<Integer> resultsFeature = max(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_min_peak(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PEAK, serie);
        List<Integer> resultsFeature = min(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer min_range_peak(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PEAK, serie);
        List<Integer> resultsFeature = range(resultsPattern);
        Integer resultAggregator = min(resultsFeature);
        return resultAggregator;
    }
    ...
    public static Integer max_one_peak(List<Integer> serie) {
        List<List<Integer>> resultsPattern = applyPattern(PEAK, serie);
        List<Integer> resultsFeature = one(resultsPattern);
        Integer resultAggregator = max(resultsFeature);
        return resultAggregator;
    }
